...
print("Esta es la categoria que has elegido: ", indice_dict_keys[numero_elegido_usuaria])

#Otro input para meter una palabra relacionada con la categoria seleccionada antes (ej: circle)
print("Escribe una palabra de la categoria", str(indice_dict_keys[numero_elegido_usuaria]), "para ver si es la palabra secreta:")
...
print("¿La palabra que has elegido,", palabra_adivinar, ", es igual a la palabra secreta?")
