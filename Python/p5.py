...
print("\n")
str_bienvenida = "Este es el juego de las tres en raya!. Aquí tenemos el tablero. Escribe un caracter (o, x) y luego las coordenadas. Te iremos guiando. Esperamos que disfrutes"
...
type(input_usuaria_tupla) #se puede quitar
...
print("La 2 jugadoras que han participado son ", letra, letra2 )